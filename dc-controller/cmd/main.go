...
func main() {
	...
	if err := (&controller.DataConnectServiceReconciler{
		...
		RestImage: controller.EnvOrDefault(
			...
			"quay.io/opendatahub/odh-data-connect-hub-rest@sha256:094399152c890329ed7c34b86864000c473235d6cba7619f1a79db135151d6fb", //nolint:lll
		),
		FlightImage: controller.EnvOrDefault(
			"RELATED_IMAGE_ODH_DATA_CONNECT_HUB_FLIGHT_IMAGE",
			"quay.io/opendatahub/odh-data-connect-hub-flight@sha256:33d2e20eaf0415c38f8c1be013fdf626767ede25f4ff3dd87f325c79e966f373", //nolint:lll
		),
